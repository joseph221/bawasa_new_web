<?php
    return [
        ...
        "Tenders" => "Zabuni",
        "Vacancies" => "Ajira",
        "Staff_Mail" => "Barua Pepe",
        "Home" => "Mwanzo",
        "Swahili" => "English",

        "about_us" => "Kuhusu sisi",
            "org_str" => "Muhundo Wa Tahasisi",
            "History" => "Historia",
            "Mission_Vision" => "Mipango na Mikakati",
            "Board_Members" => "Wanachama Wa Bodi",
            "Management" => "Utawala",
        ...
        "Media_centre"=> "Kituo cha habari",
            "Press_Release" => "Taarifa Kwa Umma",
            "Video" => "Kumbukumbu ya Video",
            "Photo" => "Kumbukumbu ya picha",
            "Speeches" => "Hotuba",

        "office_areas"=> "Ofisi za kanda",
            "Kateshi" => "Kanda ya Kateshi",
            "Bashnet" => "Kanda ya Bashnet",
        ...
        "bbt_heading1"=> "MAMLAKA YA MAJISAFI NA USAFI WA MAZINGIRA MJI WA BABATI",
        "en" => "en",
        "Anouncements" => "Matangazo",
        "News" => "Habari",
        "events" => "Matukio",
