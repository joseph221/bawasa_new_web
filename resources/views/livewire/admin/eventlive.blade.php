        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add" action="/add_event" method="post" enctype="multipart/form-data"
                        autocomplete="off">
            ...
            <div class="card">
                ...
                @if ($selectPage)
                    <div class="col-md-10 ml-4">
                        @if ($selectAll)
                            <div>
                                You have selected <strong>{{ $events->total() }}</strong> All items.
                            </div>
                        @else
                            <div>
                                You have selected <strong>{{ count($checked) }}</strong> items,Do you want to select
                                All <strong>{{ $events->total() }}</strong>?
                            ...
                            <tbody>
                                @foreach ($events as $d)
                                    <tr class=" @if ($this->ischecked($d->id)) table-primary @endif">
                                        ...
                                        <td><img src="{{ asset('uploads/' . $d->image) }}" alt=""
