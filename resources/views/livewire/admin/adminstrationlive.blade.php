        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add" action="{{ url('managments') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" id="" class="form-control" required>
                                ...
                                <option value="HD">Head Of Departments</option>
                                <option value="HU">Heads of units</option>
                            </select>
                            @error('desc')
                                <span class="invalid-feedback text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
            ...
            <div class="card">
                ...
                @if ($selectPage)
                    <div class="col-md-10 ml-4">
                        @if ($selectAll)
                            <div>
                                You have selected <strong>{{ $managments->total() }}</strong> All items.
                            </div>
                        @else
                            <div>
                                You have selected <strong>{{ count($checked) }}</strong> items,Do you want to select
                                All <strong>{{ $managments->total() }}</strong>?
                            ...
                            <tbody>
                                @foreach ($managments as $d)
                                    <tr class=" @if ($this->ischecked($d->id)) table-primary @endif">
                                        ...
                                        @include('admin.administration.action')
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
